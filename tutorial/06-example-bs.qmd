...
structural estimates value each treaty feature in willingness-to-pay
terms, alongside the compensating-differential and subgroup views used in
the other chapters. It illustrates the general pattern ---
