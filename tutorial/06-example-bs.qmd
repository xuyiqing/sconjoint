...
paper's three applications, included to show the workflow on a design
with a numeric cost attribute:

- Because cost is measured in dollars, the structural estimates value
  each treaty feature in willingness-to-pay terms.
- The compensating-differential and subgroup views from the other
  chapters carry over unchanged.
- It illustrates the general pattern --- fit once, then read off
  interpretable quantities --- on a design where the natural unit is a
  price.
